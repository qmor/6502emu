...
public enum OpCodes {
    ...
    STA_ZP(0x85,NO_AFFECTS,3,AddressMode.NONE),
    STA_ZP_X(0x95,NO_AFFECTS,4,AddressMode.NONE),
    STA_ABSOLUTE(0x8D,NO_AFFECTS,4,AddressMode.NONE),
    STA_ABSOLUTE_X(0x9D,NO_AFFECTS,5,AddressMode.NONE),
    STA_ABSOLUTE_Y(0x99,NO_AFFECTS,5,AddressMode.NONE),
    STA_INDIRECT_X(0x81,NO_AFFECTS,6,AddressMode.NONE),
    STA_INDIRECT_Y(0x91,NO_AFFECTS,6,AddressMode.NONE),

    STX_ZP(0x86, NO_AFFECTS,3,AddressMode.NONE),
    STX_ZP_Y(0x96, NO_AFFECTS,4,AddressMode.NONE),
    STX_ABSOLUTE(0x8e, NO_AFFECTS,4,AddressMode.NONE),

    STY_ZP(0x84, NO_AFFECTS,3,AddressMode.NONE),
    STY_ZP_X(0x94, NO_AFFECTS,4,AddressMode.NONE),
    STY_ABSOLUTE(0x8c, NO_AFFECTS,4,AddressMode.NONE),
